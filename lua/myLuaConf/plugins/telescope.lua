...
return {
  {
    ...
    keys = {
      ...
      { "<leader>F",live_grep_git_root, mode = {"n"}, desc = 'Live grep', },
      { "<leader>/", function()
      ...
      { "<leader>b", function() return require('telescope.builtin').buffers() end, mode = {"n"}, desc = 'Find existing [b]uffers', },
      ...
      { "<leader>f", function() return require('telescope.builtin').find_files() end, mode = {"n"}, desc = 'Find [f]iles', },
